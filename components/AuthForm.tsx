    ...
    <section className='auth-form' >
        ...
        <Link href="/" className="cursor-pointer flex items-center gap-1" >
            ...
            alt="MySaeF logo"
             ...
             />
             <h1 className='text-26 font-ibm-plex-serif font-bold text-black-1' >My SaeF</h1>
            </Link>
            <div className='flex flex-col gap-1 md:gap-3'>
                ...
                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
                    ...
                    <div className='flex gap-4'>
                            <CustomInput 
                        control={ form.control } name='state' label='State' placeholder='Example: BS'
                        />
                            <CustomInput 
                        control={ form.control } name='postalCode' label='Postal Code' placeholder='Example: 12345'
                        />
                    </div>
                    <div className='flex gap-4'>
                            <CustomInput 
                        control={ form.control } name='dateOfBirth' label='Date of Birth' placeholder='GG-MM-AAAA'
                        />
                            <CustomInput 
